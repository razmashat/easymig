/*
 * IDENTIFICATION:
 * stub generated Tue Apr 30 20:35:49 2019
 * with a MiG generated by bootstrap_cmds-96.20.2.250.2
 * OPTIONS: 
 *	KernelServer
 */
...
mig_internal kern_return_t __MIG_check__Request__processor_start_t(__attribute__((__unused__)) __Request__processor_start_t *In0P)
{
...
#endif
	typedef __Request__processor_start_t __Request;
	typedef __Reply__processor_start_t Reply __attribute__((unused));
...
mig_internal kern_return_t __MIG_check__Request__processor_exit_t(__attribute__((__unused__)) __Request__processor_exit_t *In0P)
{
...
#endif
	typedef __Request__processor_exit_t __Request;
	typedef __Reply__processor_exit_t Reply __attribute__((unused));
...
#if	__MigTypeCheck
	if ( In0P->processor_cmdCnt > 12 )
		return MIG_BAD_ARGUMENTS;
	if (((msgh_size - (mach_msg_size_t)(sizeof(__Request) - 48)) / 4 < In0P->processor_cmdCnt) ||
	    (msgh_size != (mach_msg_size_t)(sizeof(__Request) - 48) + (4 * In0P->processor_cmdCnt)))
		return MIG_BAD_ARGUMENTS;
#endif	/* __MigTypeCheck */
